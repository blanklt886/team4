					...
					<div class="col-md-12">
						<div class="panel panel-default">
								...
								<div class="row">
									...
									<div class="col-md-6" align="right">
										<button type="submit" class="btn btn-primary btn-sm"
											data-toggle="modal" data-target="#goodsModal">検索</button>
							...
							<div class="panel-body">
								...
								<table>
									<tr>
										<td style="text-align: left; padding-left: 5PX;">顧客コード ：</td>
										<td style="text-align: left; padding-left: 5PX;">999</td>
									</tr>
									<tr>
						...
						<div class="row">
							...
							<div class="col-md-6" align="right">
								<button type="submit" class="btn btn-warning btn-sm"
									onclick="window.location.href='download/PR10101.xls'">登録</button>
							</div>
						</div>
					</div>
					<div class="panel-body">
